								...
								<form class="needs-validation" id="frmHpjaCobro" method="post" action="<?php echo base_url() ?>Laboratorio/crear_consulta" novalidate>
									...
									<div class="form-row">
										<div class="col-md-12">
											...
											<div class="input-group">
												<input type="text" value="<?php echo $codigo->codigo + 1; ?>" class="form-control" readonly>
												<input type="hidden" value="<?php echo $codigo->codigo + 1; ?>" class="form-control" id="nombrePaciente" name="codigo">
                                    ...
                                    <div class="form-row">
										<div class="col-md-12">
											...
											<div class="input-group">
												<input type="date" value="<?php echo date("Y-m-d"); ?>" class="form-control" id="fechaConsulta" name="fechaConsulta" required>
												<div class="invalid-tooltip">
