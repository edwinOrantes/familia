				...
				<div class="ms-panel-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <a class="btn btn-success btn-sm" href="<?php echo base_url()?>Laboratorio/examenes_laboratorio/"><i class="fa fa-arrow-left"></i> Volver </a>
                        </div>
                    </div>
				</div>
							...
							?>
										...
										<tr>
											...
											<td class="text-center"><?php
												...
												echo "<a title='Ver detalles del paciente' href='".base_url()."Laboratorio/detalle_examenes/".$paciente->idPaciente."'><i class='fas fa-eye ms-text-primary'></i></a>";
											?>
											</td>
										</tr>
