...
<div>
    ...
    <div class="contenedor">
        <div class="medicamentos">
            ...
            <p style="font-size: 12px; color: #0b88c9"><strong>RESULTADOS EXAMEN BACTERIOLOGIA</strong></p>
            <div class="detalle">
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        <tr>
                            <td style="text-align: center; font-size: 12px; background: rgba(0, 123, 255, 0.1); height: 30px" colspan="2"><strong class="borderAzul">Examen realizado: </strong> <?php echo $cabecera->nombreMedicamento; ?></td>
                        </tr>
                        <?php
