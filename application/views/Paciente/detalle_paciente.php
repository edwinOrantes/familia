                        ...
                        <div class="ms-panel ms-panel-fh mt-3">
                            <div class="ms-panel-body clearfix">
                                <ul class="nav nav-tabs tabs-bordered nav-justified" role="tablist" aria-orientation="vertical">
                                    <li role="presentation"><a href="#datos_paciente" aria-controls="datos_paciente" class="active show" role="tab" data-toggle="tab" aria-selected="true"> Paciente </a></li>
                                    ...
                                    <li role="presentation"><a href="#recetas_m" aria-controls="recetas_m" role="tab" data-toggle="tab" class="" aria-selected="false"> Recetas </a></li>
                                </ul>
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active show" id="datos_paciente">
                                        <div class="alert-primary p-1 bordeContenedor mt-3">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="recetas_m">
                                                            ...
                                                            <table id="tabla-pacientes" class="table table-striped thead-primary w-100">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center"><?php echo $row->fechaReceta; ?></td>
                                                                        <td class="text-center">
                                                                        <a href="<?php echo base_url(); ?>Consultas/receta_medica/<?php echo $row->idReceta; ?>" target="_blank" title="Imprimir receta"><i class="fa fa-print text-danger"></i></a>
                                                                        </td>
                                                                    </tr>
                                                                    <?php } ?>
                                                                </tbody>
