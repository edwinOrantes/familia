		...
		<div class="col-md-12">
			...
			<nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">Busqueda pacientes</a></li>
                </ol>
            </nav>
			...
			<div class="ms-panel">
				<div class="ms-panel-header">
                    <div class="row">
                        <div class="col-md-6">
                            <form class="form" id="frmBusquedaPaciente" action="<?php echo base_url(); ?>Paciente/resultado_busqueda" method="post">
                        ...
                        <div class="col-md-6">
                            <form class="form" id="" action="<?php echo base_url(); ?>Paciente/buscar_por_dui" method="post">
                                <input type="text" data-mask="99999999-9" class="form-control" list="listaPacientes" placeholder="DUI del paciente" id="duiPaciente" name="duiPaciente" required>
							</form>
                        </div>
                    </div>
				</div>
