                        ...
                        <div class="px-2 mb-3">
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="invalid-tooltip">Ingrese quien recibe el $</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control numeros" id="cuentaGasto" name="cuentaGasto" placeholder="Ingrese la cuenta del banco" onkeypress="return soloNumeros(event)" required="">        
