                                ...
                                <div class="table-responsive mt-3">
                                    <table id="tabla-medicamentos-seleccionados" class="table table-striped thead-primary ">
                                        ...
                                        <tbody>
                                            ...
                                            <!-- Descuento -->
                                            <tr id="">
                                                    <td class="text-right" scope="row" colspan="5"><strong>(-) Descuento </strong></td>
                                                    <td class="text-center" colspan="2">
                                                        <label for="" id=""><strong>$ <?php echo number_format(($facturas->descuentoCompra), 2); ?></strong></label>
                                                    </td>
                                                </tr>
                                            <!-- Fin descuento -->
                                ...
                                <form action="<?php echo base_url(); ?>Botiquin/guardar_iva" method="POST">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="descuentoCompra" name="descuentoCompra" placeholder="Ingrese la cantidad de descuento" required>
                                                <div class="invalid-tooltip">
                                    ...
                                    <div class="form-row">
                                        <div>
                                            <input type="hidden" value="<?php echo $facturas->idFactura; ?>" name="idFactura">
