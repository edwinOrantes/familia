                                    ...
                                    <tr>
										...
										<?php
                                            ...
                                            if($this->session->userdata("nivel") == 1){
												echo "<a onclick='actualizarProveedor($id, $codigo, $empresa, $nrc, $nit, $telefono, $direccion)' href='#actualizarProveedor' data-toggle='modal'><i class='fas fa-edit ms-text-success'></i></a>";
...
<script>
	...
	function actualizarProveedor(id, codigo, empresa, nrc, nit, telefono, direccion){
