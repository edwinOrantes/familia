						...
						<div class="col-md-12">
							<form class="needs-validation" method="post" action="<?php echo base_url(); ?>Botiquin/guardar_compra" novalidate>
								...
								<div class="form-row">
									...
									<input type="hidden" id="estadoFactura" name="estadoFactura">
								</div>

								<div class="text-center" id="">
									<button class="btn btn-primary mt-4 d-inline w-20" type="submit"><i class="fa fa-arrow-right"></i> Siguiente</button>
