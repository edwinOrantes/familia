                ...
                <div class="ms-panel-header">
                    <div class="row">
                        ...
                        <div class="col-md-5 text-right" id="divBotonera">
                            <button class="btn btn-primary btn-sm" href="#agregarGasto" data-toggle="modal"><i class="fa fa-plus"></i> Agregar gasto</button>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <?php
                                                   echo "<a title='Editar datos' href='#editarGasto' onclick='editarGasto($id, $tipo, $monto, $entregado, $idCuenta, $fecha, $entidad, $idProveedor, $pago, $numero, $descripcion, $codigo, $efectuado, $banco, $ncuenta)' data-toggle='modal'><i class='fas fa-edit ms-text-primary'></i></a>";
...
<!-- Modal para agregar datos del gasto-->
    <div class="modal fade" id="agregarGasto" tabindex="-1" role="dialog" aria-hidden="true">
                                ...
                                <form class="needs-validation" id="" method="post" action="<?php echo base_url() ?>Gastos/guardar_gasto" novalidate>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <!-- <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="date" class="form-control" value="<?php echo date("Y-m-d"); ?>" id="fechaGasto" name="fechaGasto" required>
                                                <div class="invalid-tooltip">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control" id="entidadGasto" name="entidadGasto" required>
                                                    <option value="">.:: Seleccionar ::.</option>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control controlInteligente" id="idProveedorGasto" name="idProveedorGasto" required>
                                                    <option value="">.:: Seleccionar ::.</option>
                                                    <?php
