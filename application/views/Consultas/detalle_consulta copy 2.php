                    ...
                    <!-- Tabs -->
                       <div class="ms-panel-body clearfix">
                            <ul class="nav nav-tabs d-flex nav-justified mb-1" role="tablist">
                                ...
                                <li role="presentation"><a href="#vacunacion" aria-controls="vacunacion" role="tab" data-toggle="tab">Vacunación </a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <div class="col-md-12 text-center">
                                                    ...
                                                    <textarea name="presenteEnfermedad" id="presenteEnfermedad" class="form-control bordes" cols="30" rows="13"><?php echo $consulta->presenteEnfermedad; ?></textarea>
                                                </div>
                                        </div>
...
`                               </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="vacunacion">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <table class="table table-sm text-center">
                                                <tr class="bg-primary text-white">
                                                    <td colspan=2>RECIEN NACIDOS</td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Vacuna</strong></td>
                                                    <td><strong>Aplicada</strong></td>
                                                </tr>
                                                <tr>
                                                    <td>BCG</td>
                                                    <td>
                                                ...
                                                <tr class="bg-primary text-white">
                                                    <td colspan=2>2, 4 y 6 MESES DE EDAD</td>
                                                </tr>
                                                <tr>
                                                    <td>Pentavalente</td>
                                                    <td>
                                                ...
                                                <tr class="bg-primary text-white">
                                                    <td colspan=2>12 MESES DE EDAD</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr class="bg-primary text-white">
                                                    <td colspan=2>15 MESES DE EDAD</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr class="bg-primary text-white">
                                                    <td colspan=2>18 MESES DE EDAD</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr class="bg-primary text-white">
                                                    <td colspan=2>24 MESES DE EDAD</td>
                                                </tr>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <tr class="bg-primary text-white">
                                                ...
                                                <tr class="bg-primary text-white">
                                                    <td colspan=2>ADOLESCENTES Y ADULTOS</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr class="bg-primary text-white">
                                                    <td colspan=2>MUJERES EMBARAZADAS</td>
                                                </tr>
                                                <tr>
                                                    <td>TDPA</td>
                                                    <td>
                                                ...
                                                <tr class="bg-primary text-white">
                                                    <td colspan=2>ADULTOS MAYORES, GRUPOS DE RIESGO Y PERSONAS CON ENFERMEDADES CRÓNICAS</td>
                                                </tr>
                                                <tr>
                                                    <td>TD</td>
                                                    <td>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <table class="table table-borderless">
                                                        ...
                                                        <tr>
                                                            <td><a href="#indicacionExtra" data-toggle="modal" class="btn btn-outline-primary btn-block"> <i class="fa fa-plus"></i>Indicación extra</a></td>
                                                        </tr>
                                                        <tr>
...
<script>
    ...
    $(document).on("click", ".datosEnfermeria", function(e) {
        e.preventDefault();
