...
<div class="detalle">
    <table class="tabla_detalle">
        ...
        <!-- Servicios externos -->
            ...
            ?>
                <tr>
                    <td style="text-align: left; padding-left: 10x;"><?php echo $externo->nombreExterno; ?></td>
                    <td style="text-align: center;"><?php echo $externo->cantidadExterno; ?></td>
                    <td style="text-align: center;">$ <?php echo $externo->precioExterno; ?></td>
                    <td style="text-align: center;">$ <?php echo number_format(($externo->cantidadExterno * $externo->precioExterno ), 2); ?></td>
                </tr>
            <?php
                }
            ?>
            <tr>
                <td colspan="3" style="text-align: right; padding-right: 10px;"><strong>Total externos</strong></td>
                <td style="text-align: center;">$ <?php echo number_format($totalExternos, 2); ?></td>
            </tr>
            <?php } ?>
