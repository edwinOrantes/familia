	...
	<div class="row">
		<div class="col-md-12">
			...
			<nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item" aria-current="page"> <a href="#"><i class="fa fa-users"></i> Accesos </a> </li>
                    <li class="breadcrumb-item"><a href="#">Gestión de accesos de usuario</a></li>
                </ol>
            </nav>
                                            ...
                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                        ...
                                                        echo "<a onclick='actualizarAcceso($id, $nombre, $descripcion)' href='#actualizarAcceso' data-toggle='modal'><i class='fas fa-edit ms-text-success'></i></a>";
                                                        echo "<a onclick='eliminarAcceso($id)' href='#eliminarMedicamento' data-toggle='modal'><i class='far fa-trash-alt ms-text-danger'></i></a>";
                                                    ?>
                                                    </td>
                                                </tr>
