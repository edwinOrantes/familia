    ...
    <div class="contenedor">
        ...
        <div class="detalle">
            <table class="tabla_detalle">
                <tr>
                    <td style="height: 25px; font-size: 12px;"><strong>Sangre para paciente:</strong> <?php echo $salida->codigoDonanteSalida; ?></td>
                ...
                <tr>
                    <td  style="height: 25px; font-size: 12px;" colspan="2"><strong>Paciente:</strong> <?php echo $salida->nombrePaciente; ?></td>
                </tr>
                <tr>
                    <td  style="height: 25px; font-size: 12px;" colspan="2">
                    <?php
                ...
                <tr>
                    <td style="height: 25px; font-size: 12px;" colspan="2"><strong>Médico: </strong> <?php echo $salida->nombreMedico; ?></td>
                </tr>
            </table>
