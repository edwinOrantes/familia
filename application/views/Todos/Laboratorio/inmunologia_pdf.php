...
<div>
    ...
    <div class="contenedor">
        <div class="medicamentos">
            ...
            <div style="border: 2px solid #0b88c9; padding-top: 10px; padding-bottom: 10px;">
                <div class="">
            ...
            <div class="detalle">
                <p style="font-size: 12px; color: #0b88c9; margin-top: 20px"><strong>RESULTADOS EXAMEN INMUNOLOGIA</strong></p>
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        <?php
                            ...
                            echo '<tr>
                                <th colspan="4" style="color: #0b88c9; text-align: center; font-size: 12px; background: rgba(0, 123, 255, 0.1); height: 25px" >
