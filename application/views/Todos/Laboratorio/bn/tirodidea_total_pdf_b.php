...
<div>
    <div class="contenedor">
        <div class="medicamentos">
            ...
            <p style="font-size: 11px; color: #000000; font-size: 12px"><strong>RESULTADO PRUEBAS TIROIDEAS TOTALES</strong></p>
            <div class="detalle">
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        <?php
                            ...
                            if($tiroideaTotal->muestraTiroideaTotal != ""){
                                echo '<tr>
                                        <td style="text-align: center; font-size: 12px; background: rgba(0, 0, 0, 0.1); height: 30px"  colspan=4 ><strong>Muestra: </strong>'.$tiroideaTotal->muestraTiroideaTotal.'</td>
                                    </tr>';
                            }
