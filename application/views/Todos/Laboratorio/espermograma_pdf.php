...
<div>
    ...
    <div class="contenedor">
        <div class="medicamentos">
            ...
            <p style="font-size: 12px; color: #0b88c9; margin-top: 25px"><strong>RESULTADO EXAMEN ESPERMOGRAMA</strong></p>
            <div class="detalle">
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        <tr>
                            <td style="text-align: center; font-size: 12px; background: rgba(0, 123, 255, 0.1); height: 21px" colspan="4"><strong class="borderAzul">Examen macroscópico</td>
                        </tr>
                        <?php
