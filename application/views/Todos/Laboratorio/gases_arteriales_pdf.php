...
<div>
    ...
    <div class="contenedor">
        <div class="medicamentos">
            ...
            <p style="font-size: 12px; color: #0b88c9; margin-top: 25px"><strong>RESULTADO EXAMEN GASES ARTERIALES</strong></p>
            <div class="detalle">
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        <?php
                            ...
                            if($arteriales->muestraGasesArteriales != ""){
                                echo '<tr>
                                        <td style="text-align: center; font-size: 12px; background: rgba(0, 123, 255, 0.1); height: 30px"  colspan=4 ><strong>Muestra: </strong>'.$arteriales->muestraGasesArteriales.'</td>
                                    </tr>';
                            }
