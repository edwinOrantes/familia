...
class Honorarios_Model extends CI_Model {
    ...
    public function honorarioPorMedico($id = null){
        $sql = "SELECT
                hp.idHonorarioPaquete, hc.idHoja, hc.codigoHoja, p.nombrePaciente, m.nombreMedico, hp.idHonorarioPaquete, hp.totalHonorarioPaquete, hp.originalHonorarioPaquete, hp.estadoHonorarioPaquete,
