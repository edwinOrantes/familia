...
class Reportes_Model extends CI_Model {
    ...
    public function obtenerResumenHoja($i, $f){
        // Consulta anterior
        /* $sql = "SELECT hc.idHoja, hc.fechaHoja, hc.salidaHoja, hc.totalHoja, hc.codigoHoja, hc.anulada, hc.tipoHoja, hc.descuentoHoja, p.nombrePaciente, m.nombreMedico,
                hc.correlativoSalidaHoja, hc.credito_fiscal, med.nombreMedico FROM tbl_hoja_cobro as hc INNER JOIN tbl_medicos AS med ON(hc.idMedico = med.idMedico)
                INNER JOIN tbl_pacientes as p ON(hc.idPaciente = p.idPaciente) INNER JOIN tbl_medicos as m ON(hc.idMedico = m.idMedico)
        ...
        $sql = "SELECT hc.idHoja, hc.fechaHoja, hc.salidaHoja, hc.totalHoja, hc.codigoHoja, hc.anulada, hc.tipoHoja, hc.descuentoHoja, hc.porPagos,
                hc.esPaquete, p.nombrePaciente, m.nombreMedico,
    ...
    public function extraerExternos($id){
        $sql = "SELECT hc.correlativoSalidaHoja, hc.credito_fiscal, hc.porPagos, hc.esPaquete, he.idExterno, he.idHojaExterno, he.idHoja, he.precioExterno, he.fechaExterno
