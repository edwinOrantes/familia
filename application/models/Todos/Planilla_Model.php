...
class Planilla_Model extends CI_Model {
    ...
    public function obtenerEmpleados(){
        $sql = "SELECT * FROM tbl_personal_planilla";
    ...
    public function crearPlanilla($data = null){
        if($data != null){
            $sql = "INSERT INTO tbl_planilla(quincenaPlanilla, mesPlanilla, descripcionPlanilla, fechaPlanilla) VALUES(?, ?, ?, ?)";
    ...
    public function guardarPersonalPlanilla($data = null, $p = null){
        if($data != null){
            ...
            for ($i=0; $i < sizeof($personal) ; $i++) {
                ...
                $sql = "INSERT INTO tbl_detalle_planilla(idEmpleado, salarioEmpleado, precioHoraExtra, bonoEmpleado, isssDetallePlanilla, afpDetallePlanilla, rentaDetallePlanilla, liquidoDetallePlanilla, idPlanilla) 
                        VALUES('$idEmpleado', '$salarioEmpleado', '$precioHoraExtra', '$bonoEmpleado', '$isssEmpleado', '$afpEmpleado', '$rentaEmpleado', '$liquido', '$p')";
    ...
    public function personalXPlanilla($flag = null){
        $sql = "SELECT p.nombreEmpleado, p.cargoEmpleado, p.areaEmpleado, dp.* FROM tbl_detalle_planilla AS dp
    ...
    public function planillaExcel($pivote = null){
        ...
        $sql = "SELECT pp.nombreEmpleado, dp.liquidoDetallePlanilla, dp.idEmpleado, pp.seguimientoEmpleado, p.descripcionPlanilla, p.idPlanilla FROM tbl_detalle_planilla AS dp
        ...
        public function resetearFila($row = null){
            if($row != null){
                $sql = "UPDATE tbl_detalle_planilla AS dp SET dp.otrosDetallePlanilla = '0', dp.horasExtras ='0', dp.totalHorasExtras = '0', dp.totalVacaciones = '0',
                        dp.descuentosPlanilla = '0', dp.detalleDescuentos = ' '
        ...
        public function actualizarFila($data = null){
            if($data != null){
                $sql = "UPDATE tbl_detalle_planilla SET salarioEmpleado = ?, precioHoraExtra = ?, bonoEmpleado = ?, isssDetallePlanilla = ?, afpDetallePlanilla = ?, 
                                rentaDetallePlanilla = ?, liquidoDetallePlanilla = ?
