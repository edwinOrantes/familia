    ...
    // Salidas de sangre
        public function nuevaSalida($data = null){
            if($data != null){
                ...
                $sql = "INSERT INTO tbl_donantes_salidas(nombrePaciente, edadPaciente, areaDonanteSalida, idInsumo, cantidadInsumo, precioInsumo, medicoDonanteSalida, codigoDonanteSalida)
                        VALUES(?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        public function actualizarSalida($data = null){
            if($data != null){
                ...
                $sql = "UPDATE tbl_donantes_salidas SET nombrePaciente = ?, edadPaciente = ?, areaDonanteSalida = ?, idInsumo = ?, cantidadInsumo = ?,
                        precioInsumo = ?, medicoDonanteSalida = ?
